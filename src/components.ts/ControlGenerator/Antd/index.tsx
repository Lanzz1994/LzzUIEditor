...
//General
const Button:ControlGenerate=(props:any,children:any)=><Antd.Button {...props}>{props.text}</Antd.Button>;
const ButtonGroup:ControlGenerate=(props:any,children:any)=><Antd.Button.Group {...props}>{children}</Antd.Button.Group>;
const Icon:ControlGenerate=(props:any,children:any)=><Antd.Icon {...props}>{children}</Antd.Icon>;
