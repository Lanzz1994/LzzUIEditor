...
import {Tooltip,Dropdown, Icon,Menu, InputNumber} from 'antd';
import {IconFont} from '../Tool/index';
import {InterfaceConfig,FrameworkState} from './types';
...
export interface LayoutHandleToolProps{
    ...
    hoverState:FrameworkState;
    hoverLayout:InterfaceConfig;

    dragState:FrameworkState;
    dragLayout:InterfaceConfig;
}
